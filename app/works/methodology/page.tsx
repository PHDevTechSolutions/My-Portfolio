...
// Replace baseWorkflowNodes with Agile and Waterfall methodology nodes
const baseWorkflowNodes: Omit<WorkflowNode, "position">[] = [
    {
        id: "agile-1",
        type: "workflow",
        title: "Agile: Concept",
        description: "Project initiation & vision",
        icon: FileText,
        color: "pink",
    },
    {
        ...
        description: "Short development cycles with feedback",
        icon: CheckCircle,
        color: "teal",
    },
    {
        ...
        type: "workflow",
        title: "Agile: Testing",
        description: "Continuous testing & quality assurance",
        icon: Shield,
        color: "emerald",
    },
    {
        ...
        description: "Incremental product delivery",
        icon: User,
        color: "blue",
    },
    {
        id: "waterfall-1",
        type: "workflow",
        title: "Waterfall: Requirements",
        description: "Gather all requirements upfront",
        icon: FileText,
        color: "purple",
    },
    {
        id: "waterfall-2",
        type: "workflow",
        title: "Waterfall: Design",
        description: "Complete system design phase",
        icon: Settings,
        color: "indigo",
    },
    {
        id: "waterfall-3",
        type: "workflow",
        title: "Waterfall: Implementation",
        description: "Build according to design",
        icon: User,
        color: "amber",
    },
    {
    ...
    },
    {
        id: "waterfall-5",
        type: "workflow",
        title: "Waterfall: Maintenance",
        description: "Post-release maintenance and support",
        icon: Server,
        color: "gray",
    },
];

// Connections between Agile and Waterfall steps
const workflowConnections: WorkflowConnection[] = [
    // Agile flow
    { from: "agile-1", to: "agile-2" },
    { from: "agile-2", to: "agile-3" },
    { from: "agile-3", to: "agile-4" },

    // Waterfall flow
    { from: "waterfall-1", to: "waterfall-2" },
    { from: "waterfall-2", to: "waterfall-3" },
    { from: "waterfall-3", to: "waterfall-4" },
    { from: "waterfall-4", to: "waterfall-5" },
];
...
export default function HeroBlock() {
    ...
    useEffect(() => {
        function updatePositions() {
            const workflowWidth = canvasRefWorkflow.current?.clientWidth ?? NODE_WIDTH + 100;
            ...
            <div className="relative w-full overflow-hidden rounded-2xl border border-border/40 bg-background/60 backdrop-blur p-4 sm:p-6">
                ...
                <div className="relative w-full overflow-hidden rounded-2xl border border-border/40 bg-background/60 backdrop-blur p-4 sm:p-6">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        ...
                        {renderDiagram(workflowNodes, workflowConnections, canvasRefWorkflow, "Methodology workflow canvas")}
                    </div>
                </div>
