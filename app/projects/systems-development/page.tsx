...
const defaultProjects: ProjectCardProps[] = [
    {
        title: "Taskflow",
        description:
            "CRM Platform tools for Time and Motion and Daily Activity Tracking of Sales with integration on SAP, Warehouse, Ticketing and Time Attendance",
        tags: ["React", "Node.js", "Shadcn", "TailwindCSS", "Next JS", "Neon", "Supabase", "MongoDB", "Firebase", "Upstash Redis", "Vercel"],
        image: "/projects/taskflow.png",
        develop: "Leroux Y Xchire",
        assign: "Leroux Y Xchire",
        links: {
            demo: "https://taskflow-demo-v2.vercel.app/",
            github: "https://github.com/PHDevTechSolutions/Taskflow-Demo-V2",
        },
    },
    {
        title: "Ecodesk",
        description:
            "Customer Service Request ticketing system with real-time updates, escalation, and resolution tracking.",
        tags: ["React", "Node.js", "Shadcn", "TailwindCSS", "Next JS", "MongoDB", "Supabase", "Socket.io", "Vercel"],
        image: "/projects/ecodesk.png",
        develop: "Leroux Y Xchire",
        assign: "Aarron Espiritu",
        links: {
            demo: "https://ecodesk-erp.vercel.app/",
            github: "https://github.com/PHDevTechSolutions/Ecodesk",
        },
    },
    {
        title: "Acculog Time Tracking & Attendance",
        description:
            "Time and Attendance tracking system with GPS map integration for accurate location-based employee monitoring.",
        tags: ["React", "Node.js", "Shadcn", "TailwindCSS", "Next JS", "MongoDB", "Leaflet API", "Vercel"],
        image: "/projects/acculog.png",
        develop: "Leroux Y Xchire",
        assign: "Leroux Y Xchire",
        links: {
            demo: "https://acculog-demo-navy.vercel.app/",
            github: "https://github.com/PHDevTechSolutions/Acculog-Demo",
        },
    },
    {
        title: "IT Portal (Main ERP Platform)",
        description:
            "Centralized ERP platform integrating all systems, websites, and cloud databases for streamlined operations and management.",
        tags: ["React", "Node.js", "Next JS", "Shadcn", "TailwindCSS", "PostgreSQL", "MongoDB", "AWS", "Vercel"],
        image: "/projects/itportal.png",
        develop: "Leroux Y Xchire",
        assign: "Leroux Y Xchire",
        links: {
            demo: "https://it-portal-dusky.vercel.app/",
            github: "https://github.com/PHDevTechSolutions/IT-Portal-Demo",
        },
    },
    {
        title: "Stash - IT Inventory System",
        description:
            "Robust IT Inventory management system for tracking hardware, software assets, and resource allocation.",
        tags: ["React", "Node.js", "Next JS", "Shadcn", "TailwindCSS", "MongoDB", "AWS", "Vercel"],
        image: "/projects/stash.png",
        develop: "Leroux Y Xchire",
        assign: "OJT Intern - Aries Balgos",
        links: {
            demo: "https://stash-it-asset-management-system.vercel.app/",
            github: "https://github.com/PHDevTechSolutions/Stash-Inventory-System",
        },
    },
    {
        title: "IT Ticketing System",
        description:
            "Efficient IT concern ticketing system for logging, tracking, and managing IT issues across the organization.",
        tags: ["React", "Node.js", "Next JS", "Shadcn", "TailwindCSS", "MongoDB", "Socket.io", "Vercel"],
        image: "/projects/ticketing.png",
        develop: "Leroux Y Xchire",
        assign: "OJT Intern - Jason Pablo",
        links: {
            demo: "https://itticketing-demo.vercel.app/",
            github: "https://github.com/PHDevTechSolutions/ITTicketing",
        },
    },
    {
        title: "Linker X",
        ...
        tags: ["React", "Next JS", "TailwindCSS", "Node.js", "MongoDB", "Vercel"],
        image: "/projects/linkerx.png",
        develop: "Leroux Y Xchire",
        assign: "Leroux Y Xchire",
        links: {
            demo: "https://linker-x-delta.vercel.app/Login",
            github: "https://github.com/PHDevTechSolutions/LinkerX",
        },
    },
    {
        title: "Shifts - Room Reservation System",
        description:
            "Room reservation system that simplifies scheduling and managing conference rooms and resources.",
        tags: ["React", "Node.js", "TailwindCSS", "Next JS", "MongoDB", "Vercel"],
        image: "/projects/shifts.png",
        develop: "Leroux Y Xchire",
        assign: "Leroux Y Xchire",
        links: {
            demo: "https://shift-reservation.vercel.app/Book",
            github: "https://github.com/ERPReactNextDev/ShiftReservation",
        },
    }
];
...
function ProjectCard({ id, title, description, tags, image, links, develop, assign, className }: ProjectCardProps) {
    return (
        <motion.div variants={cardVariants} className={cn("w-full max-w-[400px]", className)}>
            <Card className="group relative h-full overflow-hidden rounded-none border-white/10 bg-white/5 backdrop-blur-sm transition-all duration-300 hover:border-white/30 hover:bg-white/10">
                ...
                <div className="p-5">
                    ...
                    {/* View Info Button */}
                    <Link href={id ? `/projects/systems-development/${id}` : '#'}>
...
export default function ProjectPage() {
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                setLoading(true);
                const data = await getProjectsByType("system");
    ...
    return (
        <>
            ...
            <main
                ...
                role="main"
                aria-label="System Development Projects"
            >
                {/* Loading State */}
                {loading && (
