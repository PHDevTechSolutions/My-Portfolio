  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Mobile App Preview Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          {/* Left Column - Mobile Phone Frame */}
          <div className="flex flex-col items-center space-y-4">
            {images.length > 0 && (
              ...
              >
                ...
                <div className="relative mx-auto" style={{ width: '280px', maxWidth: '100%' }}>
                  {/* Phone Bezel */}
                  <div className="bg-gray-800 rounded-[3rem] p-2 shadow-2xl border border-gray-700">
                    {/* Screen */}
                    <div className="relative bg-black rounded-[2.5rem] overflow-hidden aspect-[9/19]">
                      ...
                      <div className="absolute inset-0 flex items-center justify-between px-2 z-20">
                        {images.length > 1 && (
                          <>
                            <button
                              onClick={prevImage}
                              className="bg-black/50 p-2 hover:bg-black/70 transition rounded-full"
                            >
                      ...
                      <button
                        ...
                        className="absolute bottom-4 right-4 bg-black/50 p-2 hover:bg-black/70 transition rounded-full z-20"
                      >
            ...
            {/* Screen Thumbnails - Mobile Style */}
            {images.length > 1 && (
            ...
            <motion.div
              ...
              className="bg-white/5 border border-white/10 p-6 rounded-none w-full"
            >
          ...
          <motion.div
            ...
            className="space-y-4 lg:max-w-md"
          >
      ...
      {lightboxOpen && (
        ...
        >
          <button
            onClick={closeLightbox}
            className="absolute top-4 right-4 p-2 bg-white/10 hover:bg-white/20 transition z-50"
          >
          ...
          {images.length > 1 && (
            <>
              <button
                ...
                className="absolute left-4 top-1/2 -translate-y-1/2 p-3 bg-white/10 hover:bg-white/20 transition z-50"
              >
                <ChevronLeft className="h-6 w-6 text-white" />
              </button>
              <button
                onClick={(e) => { e.stopPropagation(); nextLightboxImage(); }}
                className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-white/10 hover:bg-white/20 transition z-50"
              >
                <ChevronRight className="h-6 w-6 text-white" />
              </button>
            </>
          )}
          {/* Mobile Phone Frame in Lightbox */}
          <div
            className="relative mx-4"
            style={{ width: 'min(375px, 40vw)', height: 'min(812px, 80vh)' }}
            onClick={(e) => e.stopPropagation()}
          >
            {/* Phone Frame */}
            <div className="bg-gray-800 rounded-[3rem] p-2 shadow-2xl border border-gray-700 h-full">
